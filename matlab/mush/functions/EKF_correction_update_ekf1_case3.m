function [xp, Pp, S, in,K] = EKF_correction_update_ekf1_case3( x, P, y,h, H, R, M )
...
if in(1)>345*pi/180 && in(1)<(360)*pi/180
   hx(1)=360*pi/180+hx(1);
elseif in(1)>-(360)*pi/180 && in(1)<-345*pi/180
    y(1)=y(1)+360*pi/180;
else
    y(1)=y(1);
    hx(1)=hx(1);
